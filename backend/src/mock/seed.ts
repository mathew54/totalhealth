...
export const SEED: Record<string, Row[]> = {
  ...
  tarifas_consulta: [
    { id: 'AA000000-0000-0000-0000-000000000001', clinica_id: CLINICA_ID, nombre: 'Consulta General', tipo: 'consulta_general', especialidad: 'medicina_general', medico_id: null, precio_usd: 30, impuesto: 'gravado', duracion_min: 30, activo: true, created_at: dayAgo(30), updated_at: dayAgo(30) },
    { id: 'AA000000-0000-0000-0000-000000000002', clinica_id: CLINICA_ID, nombre: 'Especialista Cardiología', tipo: 'especialista', especialidad: 'cardiologia', medico_id: AUTH_USERS[5].id, precio_usd: 50, impuesto: 'gravado', duracion_min: 45, activo: true, created_at: dayAgo(20), updated_at: dayAgo(20) },
    { id: 'AA000000-0000-0000-0000-000000000003', clinica_id: CLINICA_ID, nombre: 'Especialista Traumatología', tipo: 'especialista', especialidad: 'traumatologia', medico_id: AUTH_USERS[6].id, precio_usd: 45, impuesto: 'gravado', duracion_min: 40, activo: true, created_at: dayAgo(20), updated_at: dayAgo(20) },
    { id: 'AA000000-0000-0000-0000-000000000004', clinica_id: CLINICA_ID, nombre: 'Control', tipo: 'control', especialidad: null, medico_id: null, precio_usd: 20, impuesto: 'exento', duracion_min: 20, activo: true, created_at: dayAgo(20), updated_at: dayAgo(20) },
    { id: 'AA000000-0000-0000-0000-000000000005', clinica_id: CLINICA_ID, nombre: 'Telemedicina', tipo: 'telemedicina', especialidad: null, medico_id: null, precio_usd: 25, impuesto: 'gravado', duracion_min: 30, activo: true, created_at: dayAgo(15), updated_at: dayAgo(15) },
  ],

  consultas: [
    { id: '30000000-0000-0000-0000-000000000001', paciente_id: '20000000-0000-0000-0000-000000000001', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: dayAgo(7, 9), motivo: 'Chequeo general', diagnostico: 'Paciente sano', notas: null, estado: 'completada', origen: 'staff', tipo_consulta: 'consulta_general', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000001', monto_base_usd: 30, estado_pago: 'pagada', created_at: dayAgo(7), updated_at: dayAgo(7) },
    { id: '30000000-0000-0000-0000-000000000002', paciente_id: '20000000-0000-0000-0000-000000000002', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: dayAgo(4, 11), motivo: 'Dolor abdominal', diagnostico: 'Gastritis leve', notas: 'Indicar dieta blanda', estado: 'completada', origen: 'staff', tipo_consulta: 'consulta_general', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000001', monto_base_usd: 30, estado_pago: 'pagada', created_at: dayAgo(4), updated_at: dayAgo(4) },
    { id: '30000000-0000-0000-0000-000000000003', paciente_id: '20000000-0000-0000-0000-000000000003', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: dayAgo(2, 15), motivo: 'Control de glicemia', diagnostico: 'Pendiente de resultados', notas: null, estado: 'completada', origen: 'staff', tipo_consulta: 'control', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000004', monto_base_usd: 20, estado_pago: 'pagada', created_at: dayAgo(2), updated_at: dayAgo(2) },
    { id: '30000000-0000-0000-0000-000000000004', paciente_id: '20000000-0000-0000-0000-000000000004', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: future(1, 9), motivo: 'Primera consulta', diagnostico: null, notas: null, estado: 'programada', origen: 'online', tipo_consulta: 'consulta_general', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000001', monto_base_usd: 30, estado_pago: 'pendiente', created_at: dayAgo(0), updated_at: dayAgo(0) },
    { id: '30000000-0000-0000-0000-000000000005', paciente_id: '20000000-0000-0000-0000-000000000001', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: future(3, 11), motivo: 'Control anual', diagnostico: null, notas: null, estado: 'programada', origen: 'online', tipo_consulta: 'control', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000004', monto_base_usd: 20, estado_pago: 'pendiente', created_at: dayAgo(0), updated_at: dayAgo(0) },
    // Consulta en curso con la Dra. Suárez (cardiología).
    { id: '30000000-0000-0000-0000-000000000006', paciente_id: '20000000-0000-0000-0000-000000000001', medico_id: AUTH_USERS[5].id, clinica_id: CLINICA_ID, fecha_hora: hoyA(9), motivo: 'Evaluación cardiovascular', diagnostico: null, notas: 'Revisar palpitaciones', estado: 'en_curso', origen: 'staff', tipo_consulta: 'especialista', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000002', monto_base_usd: 50, estado_pago: 'pendiente', created_at: dayAgo(0), updated_at: dayAgo(0) },
    // Consulta cancelada.
    { id: '30000000-0000-0000-0000-000000000007', paciente_id: '20000000-0000-0000-0000-000000000003', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: dayAgo(1, 14), motivo: 'Revisión de exámenes', diagnostico: null, notas: 'Paciente canceló por traslado', estado: 'cancelada', origen: 'staff', tipo_consulta: 'consulta_general', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000001', monto_base_usd: 30, estado_pago: 'anulada', created_at: dayAgo(3), updated_at: dayAgo(1) },
    // Consulta programada de paciente crónico (turno asociado en sala de espera).
    { id: '30000000-0000-0000-0000-000000000008', paciente_id: '20000000-0000-0000-0000-000000000012', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: hoyA(10), motivo: 'Control de presión arterial', diagnostico: null, notas: null, estado: 'programada', origen: 'staff', tipo_consulta: 'control', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000004', monto_base_usd: 20, estado_pago: 'pendiente', created_at: dayAgo(0), updated_at: dayAgo(0) },
    // Consulta con el Dr. Ramírez (traumatología) completada.
    { id: '30000000-0000-0000-0000-000000000009', paciente_id: '20000000-0000-0000-0000-000000000008', medico_id: AUTH_USERS[6].id, clinica_id: CLINICA_ID, fecha_hora: dayAgo(6, 10), motivo: 'Dolor de rodilla', diagnostico: 'Gonalgia por desgaste meniscal', notas: 'Reposo relativo y fisioterapia', estado: 'completada', origen: 'staff', tipo_consulta: 'especialista', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000003', monto_base_usd: 45, estado_pago: 'pagada', created_at: dayAgo(6), updated_at: dayAgo(5) },
    // Consulta programada con la Dra. Suárez para paciente crónico.
    { id: '30000000-0000-0000-0000-000000000010', paciente_id: '20000000-0000-0000-0000-000000000012', medico_id: AUTH_USERS[5].id, clinica_id: CLINICA_ID, fecha_hora: future(2, 16), motivo: 'Cardiopatía hipertensiva — control', diagnostico: null, notas: null, estado: 'programada', origen: 'online', tipo_consulta: 'especialista', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000002', monto_base_usd: 50, estado_pago: 'pendiente', created_at: dayAgo(1), updated_at: dayAgo(1) },
    // Consulta completada del paciente demo V-19021231 (Andrés Salazar).
    { id: '30000000-0000-0000-0000-000000000011', paciente_id: '20000000-0000-0000-0000-000000000015', medico_id: AUTH_USERS[2].id, clinica_id: CLINICA_ID, fecha_hora: dayAgo(3, 10), motivo: 'Chequeo de rutina — perfil metabólico', diagnostico: 'En observación, pendiente de exámenes', notas: 'Solicitar glicemia y perfil lipídico', estado: 'completada', origen: 'staff', tipo_consulta: 'consulta_general', tarifa_consulta_id: 'AA000000-0000-0000-0000-000000000001', monto_base_usd: 30, estado_pago: 'pagada', created_at: dayAgo(3), updated_at: dayAgo(3) },
  ],
  ...
  examenes_laboratorio: [
    ...
    // Perfil bioquímico, hepático y lipídico (rangos por edad/sexo en parametros_referencia).
    { id: '40000000-0000-0000-0000-000000000006', clinica_id: CLINICA_ID, nombre: 'Creatinina', categoria: 'Química', precio: 10, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '2160-0', codigo_externo: 'CRE-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000007', clinica_id: CLINICA_ID, nombre: 'Urea', categoria: 'Química', precio: 10, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '3057-3', codigo_externo: 'URE-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000008', clinica_id: CLINICA_ID, nombre: 'Sodio (Na+)', categoria: 'Química', precio: 10, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '2951-2', codigo_externo: 'SOD-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000009', clinica_id: CLINICA_ID, nombre: 'Potasio (K+)', categoria: 'Química', precio: 10, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '2823-3', codigo_externo: 'POT-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000010', clinica_id: CLINICA_ID, nombre: 'Bilirrubina total', categoria: 'Química', precio: 10, interno: true, duracion_min: 25, condiciones_previas: 'Evitar exposición prolongada de la muestra a la luz', tiempo_entrega: '24 horas', codigo_loinc: '1975-2', codigo_externo: 'BIL-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000011', clinica_id: CLINICA_ID, nombre: 'TGP (ALT)', categoria: 'Química', precio: 12, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '1742-6', codigo_externo: 'ALT-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000012', clinica_id: CLINICA_ID, nombre: 'TGO (AST)', categoria: 'Química', precio: 12, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '1920-8', codigo_externo: 'AST-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000013', clinica_id: CLINICA_ID, nombre: 'Fosfatasa alcalina', categoria: 'Química', precio: 12, interno: true, duracion_min: 25, condiciones_previas: null, tiempo_entrega: '24 horas', codigo_loinc: '6768-6', codigo_externo: 'FAL-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000014', clinica_id: CLINICA_ID, nombre: 'Triglicéridos', categoria: 'Química', precio: 12, interno: true, duracion_min: 25, condiciones_previas: 'Ayuno de 12 horas', tiempo_entrega: '24 horas', codigo_loinc: '2571-8', codigo_externo: 'TRI-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
    { id: '40000000-0000-0000-0000-000000000015', clinica_id: CLINICA_ID, nombre: 'Colesterol HDL', categoria: 'Química', precio: 12, interno: true, duracion_min: 25, condiciones_previas: 'Ayuno de 12 horas', tiempo_entrega: '24 horas', codigo_loinc: '2085-9', codigo_externo: 'HDL-01', fecha_mapeo: dayAgo(30), tipo_muestra: 'Suero', tubo: 'Rojo (s/Gel)', volumen_muestra: '2 mL', activo: true, created_at: dayAgo(30) },
  ],
  ...
  reactivo_movimientos: [
    { id: '9F100000-0000-0000-0000-000000000001', clinica_id: CLINICA_ID, reactivo_id: '91000000-0000-0000-0000-000000000001', lote_id: '9F000000-0000-0000-0000-000000000001', tipo: 'entrada', cantidad: 120, cantidad_anterior: 0, cantidad_posterior: 120, motivo: 'Recepción inicial', usuario_id: AUTH_USERS[3].id, solicitud_detalle_id: null, fecha: dayAgo(30) },
    { id: '9F100000-0000-0000-0000-000000000002', clinica_id: CLINICA_ID, reactivo_id: '91000000-0000-0000-0000-000000000002', lote_id: '9F000000-0000-0000-0000-000000000002', tipo: 'entrada', cantidad: 15, cantidad_anterior: 0, cantidad_posterior: 15, motivo: 'Recepción inicial', usuario_id: AUTH_USERS[3].id, solicitud_detalle_id: null, fecha: dayAgo(30) },
    { id: '9F100000-0000-0000-0000-000000000003', clinica_id: CLINICA_ID, reactivo_id: '91000000-0000-0000-0000-000000000003', lote_id: '9F000000-0000-0000-0000-000000000003', tipo: 'entrada', cantidad: 40, cantidad_anterior: 0, cantidad_posterior: 40, motivo: 'Recepción inicial', usuario_id: AUTH_USERS[3].id, solicitud_detalle_id: null, fecha: dayAgo(120) },
    { id: '9F100000-0000-0000-0000-000000000004', clinica_id: CLINICA_ID, reactivo_id: '91000000-0000-0000-0000-000000000004', lote_id: '9F000000-0000-0000-0000-000000000004', tipo: 'entrada', cantidad: 4, cantidad_anterior: 0, cantidad_posterior: 4, motivo: 'Recepción inicial', usuario_id: AUTH_USERS[3].id, solicitud_detalle_id: null, fecha: dayAgo(45) },
    { id: '9F100000-0000-0000-0000-000000000005', clinica_id: CLINICA_ID, reactivo_id: '91000000-0000-0000-0000-000000000005', lote_id: '9F000000-0000-0000-0000-000000000005', tipo: 'entrada', cantidad: 60, cantidad_anterior: 0, cantidad_posterior: 60, motivo: 'Recepción inicial', usuario_id: AUTH_USERS[3].id, solicitud_detalle_id: null, fecha: dayAgo(60) },
  ],
  ...
  parametros_referencia: [
    // Perfil hematológico (Hematología completa) — rangos por edad y sexo.
    { id: '9A000000-0000-0000-0000-000000000001', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hemoglobina', nombre: 'Hemoglobina', unidad: 'g/dL', normal_min: 14, normal_max: 24, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '718-7', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000002', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hemoglobina', nombre: 'Hemoglobina', unidad: 'g/dL', normal_min: 11.5, normal_max: 14.5, critico_min: null, critico_max: null, activo: true, edad_min: 2, edad_max: 12, sexo: null, codigo_loinc: '718-7', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000003', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hemoglobina', nombre: 'Hemoglobina', unidad: 'g/dL', normal_min: 13.5, normal_max: 17.5, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: 'M', codigo_loinc: '718-7', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000004', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hemoglobina', nombre: 'Hemoglobina', unidad: 'g/dL', normal_min: 12, normal_max: 15.5, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: 'F', codigo_loinc: '718-7', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000005', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hematocrito', nombre: 'Hematocrito', unidad: '%', normal_min: 44, normal_max: 64, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '4544-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000006', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hematocrito', nombre: 'Hematocrito', unidad: '%', normal_min: 35, normal_max: 43, critico_min: null, critico_max: null, activo: true, edad_min: 2, edad_max: 12, sexo: null, codigo_loinc: '4544-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000007', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hematocrito', nombre: 'Hematocrito', unidad: '%', normal_min: 42, normal_max: 52, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: 'M', codigo_loinc: '4544-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000008', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'hematocrito', nombre: 'Hematocrito', unidad: '%', normal_min: 37, normal_max: 48, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: 'F', codigo_loinc: '4544-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000009', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'leucocitos', nombre: 'Glóbulos blancos', unidad: '/µL', normal_min: 9000, normal_max: 30000, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '6690-2', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000010', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'leucocitos', nombre: 'Glóbulos blancos', unidad: '/µL', normal_min: 5000, normal_max: 19500, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '6690-2', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000011', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'leucocitos', nombre: 'Glóbulos blancos', unidad: '/µL', normal_min: 4000, normal_max: 11000, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '6690-2', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000012', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'plaquetas', nombre: 'Plaquetas', unidad: '/µL', normal_min: 150000, normal_max: 450000, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '777-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    // Hemograma complementario (para demo de resultados).
    { id: '9A000000-0000-0000-0000-000000000013', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000001', parametro: 'globulos_rojos', nombre: 'Glóbulos rojos', unidad: 'M/uL', normal_min: 4.2, normal_max: 6.1, critico_min: 3, critico_max: 8, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: null, created_at: dayAgo(25), updated_at: dayAgo(25) },
    // pH urinario (Uroanálisis).
    { id: '9A000000-0000-0000-0000-000000000014', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000004', parametro: 'ph', nombre: 'pH urinario', unidad: '', normal_min: 4.5, normal_max: 8, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: null, created_at: dayAgo(25), updated_at: dayAgo(25) },

    // Perfil bioquímico.
    { id: '9A000000-0000-0000-0000-000000000015', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000002', parametro: 'glicemia', nombre: 'Glicemia en ayunas', unidad: 'mg/dL', normal_min: 40, normal_max: 90, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '2339-0', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000016', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000002', parametro: 'glicemia', nombre: 'Glicemia en ayunas', unidad: 'mg/dL', normal_min: 70, normal_max: 110, critico_min: 50, critico_max: 250, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '2339-0', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000017', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000006', parametro: 'creatinina', nombre: 'Creatinina', unidad: 'mg/dL', normal_min: 0.3, normal_max: 1, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '2160-0', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000018', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000006', parametro: 'creatinina', nombre: 'Creatinina', unidad: 'mg/dL', normal_min: 0.2, normal_max: 0.7, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 12, sexo: null, codigo_loinc: '2160-0', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000019', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000006', parametro: 'creatinina', nombre: 'Creatinina', unidad: 'mg/dL', normal_min: 0.5, normal_max: 1.2, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '2160-0', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000020', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000007', parametro: 'urea', nombre: 'Urea', unidad: 'mg/dL', normal_min: 5, normal_max: 18, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 17, sexo: null, codigo_loinc: '3057-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000021', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000007', parametro: 'urea', nombre: 'Urea', unidad: 'mg/dL', normal_min: 15, normal_max: 45, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '3057-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000022', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000008', parametro: 'sodio', nombre: 'Sodio', unidad: 'mEq/L', normal_min: 135, normal_max: 145, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '2951-2', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000023', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000009', parametro: 'potasio', nombre: 'Potasio', unidad: 'mEq/L', normal_min: 3.7, normal_max: 5.9, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '2823-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000024', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000009', parametro: 'potasio', nombre: 'Potasio', unidad: 'mEq/L', normal_min: 3.5, normal_max: 5.1, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '2823-3', created_at: dayAgo(25), updated_at: dayAgo(25) },

    // Perfil hepático y enzimático.
    { id: '9A000000-0000-0000-0000-000000000025', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000010', parametro: 'bilirrubina_total', nombre: 'Bilirrubina total', unidad: 'mg/dL', normal_min: null, normal_max: 12, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '1975-2', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000026', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000010', parametro: 'bilirrubina_total', nombre: 'Bilirrubina total', unidad: 'mg/dL', normal_min: 0.2, normal_max: 1.2, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '1975-2', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000027', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000011', parametro: 'alt', nombre: 'TGP (ALT)', unidad: 'U/L', normal_min: 13, normal_max: 45, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '1742-6', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000028', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000011', parametro: 'alt', nombre: 'TGP (ALT)', unidad: 'U/L', normal_min: 5, normal_max: 55, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '1742-6', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000029', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000012', parametro: 'ast', nombre: 'TGO (AST)', unidad: 'U/L', normal_min: 15, normal_max: 60, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 0, sexo: null, codigo_loinc: '1920-8', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000030', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000012', parametro: 'ast', nombre: 'TGO (AST)', unidad: 'U/L', normal_min: 5, normal_max: 40, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '1920-8', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000031', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000013', parametro: 'fosfatasa_alcalina', nombre: 'Fosfatasa alcalina', unidad: 'U/L', normal_min: 150, normal_max: 450, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 17, sexo: null, codigo_loinc: '6768-6', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000032', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000013', parametro: 'fosfatasa_alcalina', nombre: 'Fosfatasa alcalina', unidad: 'U/L', normal_min: 30, normal_max: 120, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '6768-6', created_at: dayAgo(25), updated_at: dayAgo(25) },

    // Perfil lipídico.
    { id: '9A000000-0000-0000-0000-000000000033', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000003', parametro: 'colesterol_total', nombre: 'Colesterol total', unidad: 'mg/dL', normal_min: null, normal_max: 170, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 17, sexo: null, codigo_loinc: '2093-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000034', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000003', parametro: 'colesterol_total', nombre: 'Colesterol total', unidad: 'mg/dL', normal_min: null, normal_max: 200, critico_min: null, critico_max: 240, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '2093-3', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000035', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000014', parametro: 'trigliceridos', nombre: 'Triglicéridos', unidad: 'mg/dL', normal_min: null, normal_max: 90, critico_min: null, critico_max: null, activo: true, edad_min: 0, edad_max: 17, sexo: null, codigo_loinc: '2571-8', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000036', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000014', parametro: 'trigliceridos', nombre: 'Triglicéridos', unidad: 'mg/dL', normal_min: null, normal_max: 150, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: null, codigo_loinc: '2571-8', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000037', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000015', parametro: 'hdl', nombre: 'Colesterol HDL', unidad: 'mg/dL', normal_min: 40, normal_max: null, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: 'M', codigo_loinc: '2085-9', created_at: dayAgo(25), updated_at: dayAgo(25) },
    { id: '9A000000-0000-0000-0000-000000000038', clinica_id: CLINICA_ID, examen_id: '40000000-0000-0000-0000-000000000015', parametro: 'hdl', nombre: 'Colesterol HDL', unidad: 'mg/dL', normal_min: 50, normal_max: null, critico_min: null, critico_max: null, activo: true, edad_min: null, edad_max: null, sexo: 'F', codigo_loinc: '2085-9', created_at: dayAgo(25), updated_at: dayAgo(25) },
  ],
